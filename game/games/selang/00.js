$(document).ready(function() {
    ...
    ga.async = true;
    ga.src = 'http://game.shjytan.cn/games/';
...
var mebtnopenurl = 'http://game.shjytan.cn/';
window.shareData = {
    "imgUrl": "http://game.shjytan.cn/games/selang/icon.png",
    "timeLineLink": "http://game.shjytan.cn/games/selang/",
    "tTitle": "小心色狼-微营销娱乐游戏",
...
function failHandler(t) {
    ...
    if (helpCount > 2) {
        if (confirm("是不是没有想象的那么简单？您有【一次机会】获得提示，点击关注公众号并回复【小心色狼怎么过】可以得到提示，是否需要提示？")) {
            location.href = "http://game.shjytan.cn/follow.php"
        };
        helpCount = 0
    }
};
