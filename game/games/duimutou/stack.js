...
var tite="";
	var DFW = {
		appId: "",
		TLImg: "http://game.shjytan.cn/games/duimutou/icon.png",
		url: "http://game.shjytan.cn/games/duimutou/",
...
function updateShare(stscore) {
	imgUrl = 'http://game.shjytan.cn/games/duimutou/i/icon.png';
	lineLink = 'http://game.shjytan.cn/games/duimutou';
