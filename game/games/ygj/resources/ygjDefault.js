...
var mebtnopenurl = 'http://game.shjytan.cn/games/ygj/index.html';
var rankurl = 'http://game.shjytan.cn/games/ygj/index.html';
window.shareData = {
    "imgUrl": "http://game.shjytan.cn/games/ygj/resources/logo_small.jpg",
    "timeLineLink": "http://game.shjytan.cn/games/ygj/index.html",
...
function clickMore(){
			if((window.location+"").indexOf("zf",1)>0){
				window.location = "http://game.shjytan.cn/games/ygj/index.html";
			 }
			 else{
				goHome();
			 }
